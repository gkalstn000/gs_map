...
function getTimeHTML(distance) {
    ...
    return `
        <ul class="dotOverlay distanceInfo">
            <li style="margin-bottom: 5px;"><span class="label">총거리</span><span class="number">${distance}</span>m</li>
            <li style="margin-bottom: 5px;"><span class="label">도보</span>${walkHour}${walkMin}</li>
